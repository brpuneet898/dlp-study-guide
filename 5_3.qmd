...
1. **Initialization (__init__ method):** Takes two parameters - input_dim (the number of input channels) and num_classes (the number of output classes).
...
2. **Forward Pass (forward method):** Defines the flow of data through the network.
